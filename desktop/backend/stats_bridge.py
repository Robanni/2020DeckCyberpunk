...
class StatsBridge(QObject):
    ...
    def get_INT(self): return self._stats.INT
    ...
    def get_REF(self): return self._stats.REF
    ...
    def get_TECH(self): return self._stats.TECH
    ...
    def get_COOL(self): return self._stats.COOL
    ...
    def get_ATTR(self): return self._stats.ATTR
    ...
    def get_LUCK(self): return self._stats.LUCK
    ...
    def get_MA(self): return self._stats.MA
    ...
    def get_BODY(self): return self._stats.BODY
    ...
    def get_EMP(self): return self._stats.EMP
